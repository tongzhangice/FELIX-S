...
func_ice_shelf_mask(FLOAT x, FLOAT y, FLOAT z, FLOAT *ice_shelf_mask)
{
    ...
    //if (x>555150){
    //if (x>536100){
    //if (x>523630){ /*almost conv*/
    //if (x>524130){ /*new contact*/
    //if (x>526000){ /*new contact2*/
    //if (x>519200){ /*new contact3*/
    //if (x>509834){ /*new contact3*/
    //if (x>525200){ /*new contact5*/
    //if (x>526100){ /*new contact6*/
    //if (x>527200){ /*new contact7*/
    if (x>519200){ 
        *ice_shelf_mask = 1;
    }
    else
